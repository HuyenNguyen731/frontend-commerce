        ...
        },
        {
            ...
            render: () => (
                <div style={{display: "flex", gap: "12px"}}>
                    <Button type="primary" ghost icon={<EditOutlined/>} onClick={openDrawer}/>
    ...
    return (
        <div>
            ...
            <div style={{ marginTop: '10px' }}>
                <Button ghost type="primary" onClick={openModalAddProduct} icon={<PlusOutlined />}>Thêm sản phẩm</Button>
            </div>
